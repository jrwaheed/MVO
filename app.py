...
Asset_root = Tk()
Asset_root.title("Assets")
Asset_root.geometry("400x400")
...
def index(): 
    if request.method == 'POST':
        ...
        Risk_Free_Rate.append(request.form.get('RFR_Html'))
        
        Asset_Index_Html.append(request.form.getlist('mycheckbox'))
        
        Asset_Index_Selected =[]
        for i in (Asset_Index_Html[0]):
            Asset_Index_Selected.append(int(i))
        Asset_Number = len(Asset_Index_Selected)
        #print("Assets Index selected", Asset_Index_Selected)
        ...
        #print("Interval choice", Interval_Post)
        ...
        for i in Risk_Free_Rate:
            Risk_Free_Rate2.append(float(i))
       
        print("Risk Free rate", Risk_Free_Rate2)
        print(request.form.get('RFR_Html'))
        ...
        #print('Most likely useful weights (df_WGT):',df_WGT)
        #print(df_ASSET)
        #print(df_RET)
        #print(df_SD_BEG)
        #print(df_SD_END)
        ...
        #print('Portfolio Expected return:', df_PORT_RET)
        ...
        p = figure(plot_width = 900, plot_height =500,tooltips=tooltips, title="Efficient Frontier")
        ...
        portfolio_h=[OPTIMAL_PORT_HTML.to_html(classes='table')],
    ...
    p3 = figure(plot_width = 900, plot_height =500, title="Efficient Frontier")
